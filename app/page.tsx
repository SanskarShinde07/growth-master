      ...
      <main>
        ...
        <section className="py-20 container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Box 1: Purple (Brighter) */}
            <div className="glass-card p-8 rounded-2xl border border-[#E879F9]/30 bg-gradient-to-b from-[#E879F9]/25 to-[#E879F9]/5 hover:border-[#E879F9]/70 hover:shadow-[0_0_40px_rgba(232,121,249,0.25)] transition-all duration-300 hover:-translate-y-1 group">
              <h3 className="text-2xl font-bold flex items-center gap-3 mb-4 text-white group-hover:text-[#E879F9] transition-colors">
                <span className="text-2xl">💻</span> Website Development
              </h3>
              <p className="text-white font-semibold mb-4">A website that actually gets you customers.</p>
            ...
            {/* Box 2: Green (Brighter) */}
            <div className="glass-card p-8 rounded-2xl border border-[#82E838]/30 bg-gradient-to-b from-[#82E838]/25 to-[#82E838]/5 hover:border-[#82E838]/70 hover:shadow-[0_0_40px_rgba(130,232,56,0.25)] transition-all duration-300 hover:-translate-y-1 group">
              <h3 className="text-2xl font-bold flex items-center gap-3 mb-4 text-white group-hover:text-[#82E838] transition-colors">
                <span className="text-2xl">📍</span> Local SEO
              </h3>
            ...
            {/* Box 3: Orange (Brighter) */}
            <div className="glass-card p-8 rounded-2xl border border-[#F97316]/30 bg-gradient-to-b from-[#F97316]/25 to-[#F97316]/5 hover:border-[#F97316]/70 hover:shadow-[0_0_40px_rgba(249,115,22,0.25)] transition-all duration-300 hover:-translate-y-1 group">
              <h3 className="text-2xl font-bold flex items-center gap-3 mb-4 text-white group-hover:text-[#F97316] transition-colors">
                <span className="text-2xl">📸</span> Professional Photography
              </h3>
              <p className="text-white/80 font-medium leading-relaxed">
        ...
        <section className="py-24 bg-white/[0.02] border-y border-white/5">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="glass-card p-8 rounded-2xl border-2 border-[#E879F9]/40 bg-[#E879F9]/5 hover:bg-[#E879F9]/10 hover:border-[#E879F9]/80 hover:shadow-[0_0_30px_rgba(232,121,249,0.2)] transition-all duration-300 hover:-translate-y-1">
                <div className="w-12 h-12 rounded-full bg-[#E879F9]/20 flex items-center justify-center mb-6 border border-[#E879F9]/50 shadow-[0_0_15px_rgba(232,121,249,0.3)]">
                  <svg className="w-6 h-6 text-[#E879F9]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </div>
                <h3 className="text-xl font-bold mb-4 text-white">Free Proffesional Photography</h3>
              ...
              <div className="glass-card p-8 rounded-2xl border-2 border-[#82E838]/40 bg-[#82E838]/5 hover:bg-[#82E838]/10 hover:border-[#82E838]/80 hover:shadow-[0_0_30px_rgba(130,232,56,0.2)] transition-all duration-300 hover:-translate-y-1">
                <div className="w-12 h-12 rounded-full bg-[#82E838]/20 flex items-center justify-center mb-6 border border-[#82E838]/50 shadow-[0_0_15px_rgba(130,232,56,0.3)]">
                  <svg className="w-6 h-6 text-[#82E838]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
                </div>
                <h3 className="text-xl font-bold mb-4 text-white">Zero Risk Marketing (Pay on ROI)</h3>
              ...
              <div className="glass-card p-8 rounded-2xl border-2 border-[#F97316]/40 bg-[#F97316]/5 hover:bg-[#F97316]/10 hover:border-[#F97316]/80 hover:shadow-[0_0_30px_rgba(249,115,22,0.2)] transition-all duration-300 hover:-translate-y-1">
                <div className="w-12 h-12 rounded-full bg-[#F97316]/20 flex items-center justify-center mb-6 border border-[#F97316]/50 shadow-[0_0_15px_rgba(249,115,22,0.3)]">
                ...
                <h3 className="text-xl font-bold mb-4 text-white">Honest, Upfront Pricing</h3>
        ...
        <section className="py-24 container-custom max-w-4xl">
          ...
          <div className="space-y-8">
            <div className="glass-card p-8 rounded-2xl border border-white/10 hover:border-white/20 transition-colors">
